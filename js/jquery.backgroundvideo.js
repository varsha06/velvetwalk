...
(function($) {
  ...
  $.backgroundVideo = function(el, options) {
    ...
    var buildVideo = function () {
      ...
      html += '<video muted id="'+plugin.settings.videoid+'"' + preloadString + autoplayString + loopString;

      if (plugin.settings.poster) {
        html += ' poster="' + plugin.settings.poster + '" ';
      }

      html += 'style="position:relative;top:0;left:0;bottom:0;right:0;z-index:-100;width:100%;height:100%;">';
